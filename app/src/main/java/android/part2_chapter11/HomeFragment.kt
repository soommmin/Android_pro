...
import android.part2_chapter11.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val menuData = context?.readData("menu.json", android.part2_chapter11.Menu::class.java) ?: return
    ...
    private fun initRecommendMenuList(
        homeData: Home,
        menuData: android.part2_chapter11.Menu
    ) {
    ...
    private fun initFoodList(menuData: android.part2_chapter11.Menu) {
